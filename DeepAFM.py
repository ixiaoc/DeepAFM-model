...
class DeepAFM(BaseEstimator, TransformerMixin):
    ...
    def get_batch(self, Xi, Xv, y, Xt, Xm, batch_size, index):
        ...
        return Xi[start:end], Xv[start:end], [[y_] for y_ in y[start:end]], Xt[start:end], Xm[start:end]
    ...
    def evaluate(self, Xi, Xv, y, Xt, Xm):
        """
        ...
        """
        y_pred = self.predict(Xi, Xv, Xt, Xm)
        return self.eval_metric(y, y_pred)

    def predict(self, Xi, Xv, Xt, Xm):
        """
        :param Xi: list of list of feature indices of each sample in the dataset
        :param Xv: list of list of feature values of each sample in the dataset
        ...
        while len(Xi_batch) > 0:
            ...
            feed_dict = {self.feat_index: Xi_batch,
                         ...
                         self.text_data: Xt_batch,
                         self.mask_x: Xm_batch,
                         self.label: y_batch,
    ...
    def fit(self, Xi_train, Xv_train, y_train, Xt_train, Xm_train,
        ...
        for epoch in range(self.epoch):
            ...
            if has_valid:
                valid_result = self.evaluate(Xi_valid, Xv_valid, y_valid, Xt_train_valid, Xm_train_valid)
        ...
        if has_valid and refit:
            ...
            Xt_train = Xi_train + Xt_train_valid
            Xm_train = Xm_train + Xm_train_valid
    ...
    def bilstm_network(self, input_data, mask_x, number):
        ...
        with tf.variable_scope(str(number)):
            ...
            # TODO: mask维度问题
            # mask_x = np.transpose(mask_x)
            # out_put = out_put * mask_x[:, :, None]  # N * S * (R * 2)
